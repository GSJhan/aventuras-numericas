...
function showQuestion() {
  ...
  while (opts.length < 4 && attempts < 200) { var v = correct + rnd(-spread, spread); if (opts.indexOf(v)===-1 && v!==correct) opts.push(v); attempts++; }
  while (opts.length < 4) opts.push(correct + opts.length * 3);
  opts.sort(function() { return Math.random() - 0.5; });

  var html = '<div class="question-box"><div class="question-text">' + q + ' = ?</div><div class="options">';
