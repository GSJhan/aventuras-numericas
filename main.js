...
async function handleAuth() {
  ...
  if (isRegister) {
    ...
    var newUser = {
      ...
      quizEasyCompleted: 0,
      quizNormalCompleted: 0,
      quizHardCompleted: 0,
      quizExpertCompleted: 0,
      quizPerfectRuns: 0,
      calcTotalSolved: 0,
      calcLinearSolved: 0,
      calcQuadraticSolved: 0,
      calcComplexSolved: 0,
      skillPoints: 0,
      skills: { algebra: 0, geometry: 0, speed: 0, precision: 0, infinity: 0 },
      stats: { facil: 0, normal: 0, dificil: 0, experto: 0, infinito: 0 },
      misionesCompletas: 0,
      totalMonedas: 0,
      powerDoubleUsed: 0,
      powerFiftyUsed: 0,
